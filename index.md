...
| [wiki/Updates-and-Releases.md](wiki/Updates-and-Releases.md) | Release channel (GitHub, SHA256SUMS), strata-update.sh pull updater, opt-in timer, rollout order, honest OTA-stub status | releases, updates, ops |
