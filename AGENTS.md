...
This project is indexed by GitNexus as **strata** (6031 symbols, 17469 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
