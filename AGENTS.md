...
This project is indexed by GitNexus as **strata** (6159 symbols, 17740 relationships, 288 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
