...
This project is indexed by GitNexus as **strata** (6137 symbols, 17656 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
