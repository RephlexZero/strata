...
This project is indexed by GitNexus as **strata** (5948 symbols, 17270 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
